...
// Command     : write_verilog -force -mode synth_stub -rename_top usb_cmd_fifo -prefix
//               usb_cmd_fifo_ usb_cmd_fifo_stub.v
// Design      : usb_cmd_fifo
...
module usb_cmd_fifo(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty)
