...
#
# Generated by export_simulation on Mon Nov 14 15:16:10 +0800 2016
#
################################################################################
...
switch to the './param_store_fifo.sh' script.

./param_store_fifo.sh -reset_run
...
./param_store_fifo.sh -noclean_files

For more information on the script, please type './param_store_fifo.sh -help'.
