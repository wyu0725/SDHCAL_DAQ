...
#
# Generated by Vivado on Thu Nov 24 14:45:18 +0800 2016
# IP Build 1681267 on Mon Oct 10 21:28:31 MDT 2016 
#
# usage: usb_cmd_fifo.sh [-help]
# usage: usb_cmd_fifo.sh [-lib_map_path]
# usage: usb_cmd_fifo.sh [-noclean_files]
# usage: usb_cmd_fifo.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "usb_cmd_fifo.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot usb_cmd_fifo xil_defaultlib.usb_cmd_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim usb_cmd_fifo -key {Behavioral:sim_1:Functional:usb_cmd_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./usb_cmd_fifo.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb usb_cmd_fifo.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./usb_cmd_fifo.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: usb_cmd_fifo.sh [-help]\n\
Usage: usb_cmd_fifo.sh [-lib_map_path]\n\
Usage: usb_cmd_fifo.sh [-reset_run]\n\
Usage: usb_cmd_fifo.sh [-noclean_files]\n\n\
