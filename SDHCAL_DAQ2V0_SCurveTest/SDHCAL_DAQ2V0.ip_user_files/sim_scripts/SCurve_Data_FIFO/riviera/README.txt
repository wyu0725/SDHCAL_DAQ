...
#
# Generated by export_simulation on Tue Mar 14 16:04:57 +0800 2017
#
################################################################################
...
switch to the './SCurve_Data_FIFO.sh' script.

./SCurve_Data_FIFO.sh -reset_run
...
./SCurve_Data_FIFO.sh -noclean_files

For more information on the script, please type './SCurve_Data_FIFO.sh -help'.
