...
#
# Generated by export_simulation on Fri May 19 22:08:25 +0800 2017
#
################################################################################
...
switch to the './SweepACQ_FIFO.sh' script.

./SweepACQ_FIFO.sh -reset_run
...
./SweepACQ_FIFO.sh -noclean_files

For more information on the script, please type './SweepACQ_FIFO.sh -help'.
