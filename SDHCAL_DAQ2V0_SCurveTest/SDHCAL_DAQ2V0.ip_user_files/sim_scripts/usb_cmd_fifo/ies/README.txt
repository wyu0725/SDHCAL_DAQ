...
#
# Generated by export_simulation on Thu Nov 24 14:45:18 +0800 2016
#
################################################################################
...
switch to the './usb_cmd_fifo.sh' script.

./usb_cmd_fifo.sh -reset_run
...
./usb_cmd_fifo.sh -noclean_files

For more information on the script, please type './usb_cmd_fifo.sh -help'.
