...
#
# Generated by export_simulation on Sun Dec 18 11:54:45 +0800 2016
#
################################################################################
...
switch to the './usb_data_fifo.sh' script.

./usb_data_fifo.sh -reset_run
...
./usb_data_fifo.sh -noclean_files

For more information on the script, please type './usb_data_fifo.sh -help'.
