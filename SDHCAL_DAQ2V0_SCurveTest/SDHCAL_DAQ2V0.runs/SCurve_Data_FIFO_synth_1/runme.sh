...
HD_PWD='D:/Vivado_workspace/SDHCAL_DAQ2V0_SCurveTest/SDHCAL_DAQ2V0.runs/SCurve_Data_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCurve_Data_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCurve_Data_FIFO.tcl
