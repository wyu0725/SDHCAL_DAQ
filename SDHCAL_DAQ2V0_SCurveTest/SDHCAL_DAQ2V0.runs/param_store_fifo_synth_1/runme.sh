...
HD_PWD='D:/MyProject/SDHCAL_DAQ/SDHCAL_DAQ2V0_SCurveTest/SDHCAL_DAQ2V0.runs/param_store_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log param_store_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source param_store_fifo.tcl
