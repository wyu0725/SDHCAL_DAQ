...
HD_PWD='D:/MyProject/SDHCAL_DAQ/SDHCAL_DAQ2V0_SCurveTest/SDHCAL_DAQ2V0.runs/usb_cmd_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usb_cmd_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usb_cmd_fifo.tcl
