...
for i = 1:1:PackageNumber
    PadA(i,:) = SingleMapping(AConnector(i,:),AConnectorChannel,APadChannel);%new asic data, origin asic chn,origin pad chn
...
position=zeros(PackageNumber,18,15);
GreatThan1 = zeros(18,15);
GreatThan2 = zeros(18,15);
GreatThan3 = zeros(18,15);
hit_position1=zeros(18,15);
hit_position2=zeros(18,15);
hit_position3=zeros(18,15);
        ...
        for k = 1:1:15
            ...
            if(m==1 && n==1)
                ...
                if(PadData(i,j,k) == 3)
                    ...
                    GreatThan3(j,k) =  GreatThan3(j,k)+1;
                    Over3 = [Over3 i];
                    b=0;
                   break;
                   
                elseif(PadData(i,j,k) == 2)
                    Hit3Over2 = Hit3Over2 + 1;
                    Over2 = [Over2 i];
                    GreatThan2(j,k) =  GreatThan2(j,k)+1;
                    b=0;
                    break;
                elseif(PadData(i,j,k) == 1)
                    Hit3Over1 = Hit3Over1 +1;
                    Over1 = [Over1 i];
                    GreatThan1(j,k) =  GreatThan1(j,k)+1;
                    b=0;
                    break;
                end
            end
