SlowControlAndReadScopeSet inst_name (
	.Clk                         (),
	.reset_n                     (),
	...
	.ReadScopeChannel            (),
    // *** Pins
	.SELECT                      (), // select = 1,slowcontrol register; select = 0,read register
	.SR_RSTB                     (), // Selected Register Reset
	.SR_CK                       (), // Selected Register Clock
	.SR_IN                       ()  // Selected Register Input
	);
