...
\title{SDHCAL Design Book} % Title of the book

\author[Yu Wang]{USTC SDHCAL Workgroup} % Author

\publisher{State Key Laboratory of Particle Detection and Electronics (USTC)} % Publisher
...
\par\smallcaps{ustc.edu.cn}

\par 233333\index{license}

\par\textit{Created time, \monthyear}
\end{fullwidth}

%----------------------------------------------------------------------------------------
\frontmatter

This note is used to record the design details of GEM-based DHCal.
